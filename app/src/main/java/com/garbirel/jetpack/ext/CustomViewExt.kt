package com.garbirel.jetpack.ext
...
import com.garbirel.jetpack.ui.fragment.home.HomeFragment
import com.garbirel.jetpack.ui.fragment.me.MeFragment
import com.garbirel.jetpack.ui.fragment.test.TestFragment
import com.garbirel.jetpack.weight.loadCallBack.EmptyCallback
import com.garbirel.jetpack.weight.loadCallBack.ErrorCallback
import com.garbirel.jetpack.weight.loadCallBack.LoadingCallback
...
fun BottomNavigationViewEx.interceptLongClick(vararg ids:Int) {
    ...
    for (index in ids.indices){
        bottomNavigationMenuView.findViewById<View>(ids[index]).setOnLongClickListener {
            true
        }
    }
}
